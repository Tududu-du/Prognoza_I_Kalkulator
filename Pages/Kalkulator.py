...
with col2:
    curr2 = st.selectbox('Waluta 2', ["EUR","CHF","GBP","PLN","USD"])
url = f'https://prepaid.currconv.com/api/v7/convert?q={curr1}_{curr2},{curr2}_{curr1}&compact=ultra&apiKey=pr_7419c90ef2a04c64bdcd49bc72284ab5'
re = requests.get(url)
re = re.json()
